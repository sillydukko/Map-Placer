...
public class MapAdBot extends Module {
    ...
    private final Setting<Double> placeDelay = sgGeneral.add(new DoubleSetting.Builder()
        .name("place-delay-seconds").description("Seconds to wait between frame placements.")
    ...
    private final Setting<Double> wanderRadius = sgWander.add(new DoubleSetting.Builder()
        .name("radius").description("How far to walk before picking a new direction.")
    ...
    public MapAdBot() {
        super(CATEGORY, "map-ad-bot", "Wanders and places item frames.");
    }
    ...
    private void newWanderGoal() {
        ...
        // Silent rotation to server + client yaw so movement follows
